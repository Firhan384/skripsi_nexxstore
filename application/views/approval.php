            ...
            <div class="input-barang">
                <div class="input-barang-1">
                    <form method="post" action="<?php echo site_url('welcome/pencarian_pengiriman') ?>">
                        ...
                        <input type="submit" name="cari" value="Cari" style="width:15%; height:25px; padding-left:0px;" /> <a href="<?php echo site_url('welcome/print_pengiriman') ?>" target="_blank">Print Approval</a> || <a href="<?php echo site_url('welcome/export_excel_pengiriman') ?>">Print Excel</a>
                    </form>
                </div>
                <table>
                    <thead>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $value->tanggal ?></td>
                                <td><?= $value->tanggal_approved ?></td>
                                <td>
                                    <?php
                                        if($value->tanggal_approved == NULL):
                                    ?>
                                    <a href="<?php echo site_url('welcome/edit_approval/' . $value->kode_pembelian) ?>" style="color: #8B0000; font-size: 14px;">Update</a>
                                    <?php
                                        endif;
                                    ?>
                                </td>
