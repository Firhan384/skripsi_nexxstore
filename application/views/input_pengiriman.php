    ...
    <div class="section">
        ...
        <div class="bag-menu">
            ...
            <div class="isi-barang">
                ...
                <b>INPUT PENGIRIMAN</b>
                <br><br /><br />

                <form action="<?php echo site_url('welcome/create_pengiriman') ?>" method="post">
                    Kode Pengiriman<br />
                    <input type="text" name="kode_pengiriman"/><br /><br />
                    Kode Penjualan<br />
                    ...
                    Nomor Plat <br />
                    <input type="text" name="no_polisi" style="width:40%;" required/><br /><br />
                    Nama Driver<br />
                    <input type="text" name="nama_driver" style="width: 40%" required/><br /><br />
                    Harga<br />
